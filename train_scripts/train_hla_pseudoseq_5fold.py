...
from model.model import Delphi, DelphiConfig
...
def main(args, replacement_values, code_to_exec):
    ...
    if args.no_hla:
        ...
        filename_rules = { 
          0: ('ukb_real_5_folds_2digit', ""               , "real-hla-2digits-5folds"),
          1: ('ukb_real_5_folds_4digit', ""               , "real-hla-4digits-5folds"),
          2: ('ukb_real_5_folds_2digit', ""               , "real-hla-2digits"),
          3: ('ukb_real_5_folds_4digit', ""               , "real-hla-4digits"),
          4: ('ukb_real_data'          , "ukb_real_hla2d_", "real-hla-2digits"),
          5: ('ukb_real_data'          , "ukb_real_hla4d_", "real-hla-4digits")
        }
    ...
    local_client.log_param(run_id, "val_filename", f"{data_dir}/{val_filename}")
    # local_client.log_param(run_id, "train_filename", train_filename)
    local_client.log_param(run_id, "fold", args.val_fold)

    local_client.log_param(run_id, "n_folds", 5)
    
    local_client.log_param(run_id, "weight_decays", weight_decay)
    local_client.log_param(run_id, "beta1", beta1)
    local_client.log_param(run_id, "beta2", beta2)
    local_client.log_param(run_id, "compile", compile)
