...
def add_run_trace_plotly(fig, runinfo, df_sel, ema_alpha,
    ...
    marker_mpl2plotly = {
        'o': 'circle', 's': 'square', 'D': 'diamond',
        '^': 'triangle-up', 'v': 'triangle-down',
        'P': 'cross', 'X': 'x', '*': 'star',
        '+': 'cross-thin', '1': 'triangle-down'
    }
    ls_mpl2plotly = {
        '-': 'solid',
        '--': 'dash',
...
# ==========================================================
def add_plotly_legend(fig, attr_color, attr_marker, attr_linestyle,
                      color_map, marker_map, linestyle_map):
        ...
        for val, ls in linestyle_map.items():
            fig.add_trace(
                go.Scatter(
                    ...
                    line=dict(
                        color="black",
                        dash=ls_mpl2plotly.get(ls, "solid"),
                        width=3
                    ),
                    showlegend=True,
